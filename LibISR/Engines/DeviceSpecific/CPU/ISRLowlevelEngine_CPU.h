...
namespace LibISR
{
	namespace Engine
	{
		...
		public:
			...
			void createCamCordPointCloud(ISRFloat4Image *ptcloud_out, ISRUShortImage *raw_depth_in, Vector4f instrinsic);
			...
			void createAlignedRGBImage(ISRUChar4Image *rgb_out, ISRUShortImage *raw_depth_in, ISRUChar4Image *rgb_in, Objects::ISRExHomography *home);
			...
			void createPointCloudWithPf(ISRFloat4Image *ptcloud_out, ISRUShortImage *raw_depth_in, ISRUChar4Image *rgb_in, Vector4f intrinsic, Objects::ISRHistogram *histogram);

			void preparePointCloudForRGBDTrackerAllInOne(ISRFloat4Image *ptcloud_out, ISRUShortImage *raw_depth_in, ISRUChar4Image *rgb_in, Objects::ISRCalib* calib, Objects::ISRHistogram *histogram);
