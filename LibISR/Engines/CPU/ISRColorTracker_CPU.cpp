...
ISRColorTracker_CPU::ISRColorTracker_CPU(int nObjs, Vector2i imageSize) :ISRColorTracker(nObjs, imageSize, false)
{
}
ISRColorTracker_CPU::~ISRColorTracker_CPU()
{
	if (initialized)
	{
...
float ISRColorTracker_CPU::evaluateEnergy(ISRTrackingState * trackerState)
{
...
float ISRColorTracker_CPU::computeJacobianAndHessian(float *gradient, float *hessian, ISRTrackingState * trackerState)
{
	raycastTo2DHeaviside(trackerState);
...
void ISRColorTracker_CPU::raycastTo2DHeaviside(ISRTrackingState *trackingState)
{
...
void ISRColorTracker_CPU::updatePfImage()
{		
	float *pf_ptr = pfImage->GetData(MEMORYDEVICE_CPU);
...
void ISRColorTracker_CPU::initializeTracker(const Vector2i& imageSize)
{
